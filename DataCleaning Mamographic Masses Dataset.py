...
#THE FOLLOWING CODE CAME FROM https://builtin.com/data-science/random-forest-python-deep-dive
...
model.fit(X_train, Y_train) #Use the model on the training and test data
...
#END OF CODE FROM https://builtin.com/data-science/random-forest-python-deep-dive

#THE FOLLOWING CODE CAME FROM https://mljar.com/blog/visualize-tree-from-random-forest/
...
#END OF CODE FROM https://mljar.com/blog/visualize-tree-from-random-forest/
plt.savefig('randomTreeImage.png', dpi = 300) #Saves it as a png file on your machine 

#THE FOLLOWING CODE CAME FROM https://scikit-learn.org/stable/auto_examples/ensemble/plot_forest_importances.html
#it shows which features are most important in determining whether a tumour is benign or malignant 
...
fig.tight_layout()
#END OF CODE FROM https://scikit-learn.org/stable/auto_examples/ensemble/plot_forest_importances.html
